        ...
        <div className="max-w-4xl w-full">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-6 md:p-8 lg:p-12 shadow-2xl border border-white border-opacity-20 transform hover:scale-105 transition-all duration-300 ease-out">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-6 leading-tight">
              Recognised Leader in the Service Industry
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl text-white mb-3 md:mb-4 font-medium">
              Empowering Lives Through Unmatched Service Quality
            </p>
...
<button className="bg-[#712B35] hover:bg-[#A04D5C] text-white font-semibold py-3 px-8 md:py-4 md:px-10 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 ease-out focus:outline-none focus:ring-4 focus:ring-[#A04D5C]/50">
  Contact Us
</button>
          </div>
        </div>
