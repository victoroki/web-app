...
const ClimateElectricVehicle = () => {
  const trainingModules = [
    ...
    "Charging Infrastructure Design & Installation (AC/DC, Home & Public)",
    "Grid Integration & Smart Charging with Solar PV",
    "Safety Standards & EPRA Compliance for EV Installers",
    "Business Models: EV Charging Stations, Fleet Electrification & Maintenance"
  ];
      ...
      <section className="py-20 bg-gradient-to-br from-amber-50 to-amber-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto">
            Drive the future with clean, affordable, and sustainable electric transportation for Kenya and Africa.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-4xl mx-auto border border-gray-200">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                <h3 className="text-2xl font-bold text-gray-900">EV Masterclass (Coming Q1 2026)</h3>
                <div className="flex items-center text-gray-600 mt-2">
                  <Calendar className="w-5 h-5 mr-2" />
                  <span>Exact dates TBA • 5-Day Intensive</span>
                </div>
              </div>
            ...
            <div className="bg-amber-50 p-4 rounded-lg text-gray-700">
              <strong>Format:</strong> Online + Hands-on Lab • <strong>For:</strong> Technicians, Engineers, Entrepreneurs
            </div>
          </div>
        </div>
      </section> */}
