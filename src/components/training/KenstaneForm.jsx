...
import kenstanelogo from '../img/kenstane-logo.png';
const CertificateForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://admin.torchbearer.co.ke/api/certificates/kenstane', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8 text-center">
          <div className="flex justify-center mb-4">
            <img src={kenstanelogo} alt="Logo" className="w-40 h-28 object-contain" />
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border-t-4 border-red-600">
          ...
          {loading && (
            <div className="mb-8 bg-gradient-to-r from-green-50 to-red-50 rounded-xl p-6 border border-green-200">
                  ...
                  >
                    ...
                    <div className="ml-4 flex-1">
                      <p className={`font-medium ${
                        index === loadingStep ? 'text-gray-900' : 'text-gray-600'
                      }`}>
                        {step.text}
                      </p>
                    </div>
            ...
            <button
              ...
              className={`w-full py-4 px-6 rounded-lg text-white font-bold text-lg transition-all duration-300 transform ${
                loading
                  ...
                  : 'bg-gradient-to-r from-red-600 via-black to-green-700 hover:shadow-xl hover:scale-105 active:scale-95'
              }`}
            >
              {loading ? (
